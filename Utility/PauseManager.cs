...
namespace LegendOfZelda
{
    public class PauseManager : IDrawable
    {
        ...
        public void Draw()
        {
            ...
            game._spriteBatch.DrawString(SpriteFactory.getInstance().pauseWord, "PAUSED", new Vector2(graphicsDevice.Viewport.Height / 2, graphicsDevice.Viewport.Width / 2), Color.Red);
